...
class BaseDataset(Dataset):
    ...
    def _compute_actions(self, traj_data, curr_time, goal_time):
        ...
        pose_src = traj_data["pose"][start_index:end_index]
        pose_dst = 
    ...
    def generate_augmented_image(self, rgb_img, depth_map, pose_src, K, delta_translation, delta_angle_deg) -> np.ndarray:
        """
        ...
        image = project_to_2d_image(K, points_3d, colors, rgb_img.shape[:2])
        return image
